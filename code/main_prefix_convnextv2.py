...
class BaseModel(nn.Module):
    def __init__(self, gene_size=CFG['label_size']):
        ...
        self.backbone = timm.create_model(
            model_name='convnextv2_large.fcmae_ft_in22k_in1k', # coatnet_rmlp_1_rw2_224.sw_in12k_ft_in1k  xcit_large_24_p16_224.fb_in1k  convnextv2_large.fcmae_ft_in22k_in1k
            pretrained=True,
        )
...
clusters = [AC_list, AL_list, LINC_list, SLC_list, ZNF_list]
...
for i, labels in enumerate(clusters):
    submit[labels] = submits[i][labels]
    
submit.to_csv('submit_prefix_convnextv2.csv', index=False)
